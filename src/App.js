            ...
            <div className="frame" id="card4">
               ...
               <div className="content mt-3">
                  ...
                  <ul>
                     <li className="mr-1">
                        <a
                           href="http://wordsworth.herokuapp.com/"
                           target="_blank"
                           rel="noopener noreferrer"
                        >
                           Site
                  ...
                  <h4 className="inline-header">
                     Responsive website practice: Pseudo NGV Hokusai exhibition
                  </h4>
                  <ul>
                     <li className="mr-1">
                        <a
               ...
               <div className="content">
                  ...
                  >
                     ...
                     >
                        <path
                           fill="#333"
                           d="M430 262v159h-92V272c0-37-13-63-47-63-25 0-40 18-47 34-3 6-3 14-3 23v155h-92V143h92v40h-1 1c12-19 34-46 83-46 61 0 106 39 106 125zM52 10C21 10 0 30 0 57s20 48 51 48h1c32 0 52-21 52-48-1-27-20-47-52-47zM5 421h93V143H5v278z"
                        />
                     </svg>
                  </a>
                  ...
                  <div className="tooltip-positioner">
                     <a onClick={this.copyText} onMouseLeave={this.outFunc}>
                        ...
                        >
                           <path
                              fill="#333"
                              d="M7 111v2h1v1h2v1h108l1-1h2v-1h1v-1-1-92c0-3-2-4-4-4H10c-2 0-4 1-4 4v92zm12-5l31-36 12 9h5l12-9 31 36H19zm95-7L86 65l28-19v53zM15 23h99v13L65 70 15 36V23zm0 23l28 19-28 34V46z"
                           />
                        </svg>
                     </a>
