...
class App extends React.Component {
      ...
      projects: [
         {
            ...
            img: tanto,
            desc:
               'Sales management app for an existing shop in Melbourne. School group project.',
         ...
         },
         {
            ...
            img: zodiac,
            desc:
               'Toy app that tells your personality by entering your birth year.',
         ...
         },
         {
            ...
            img: mycookbook,
            desc:
               'Hackathon group project (to log in enter test@test.com pw: 123123).',
   ...
   componentDidMount() {
      ...
      document
         .getElementsByClassName('circle-link')[0]
         .setAttribute('id', 'circle1')
      document
         .getElementsByClassName('circle-link')[1]
         .setAttribute('id', 'circle2')
      document
         .getElementsByClassName('circle-link')[2]
         .setAttribute('id', 'circle3')
   }
      ...
      return (
         <S.Container>
               ...
               <S.NoIEPlease id="no-ie">
                  <div>
                     ...
                     <p>
                        ...
                        <em>can</em> view but I tell you it's not as attractive.{' '}
                        <br />
                        I recommend{' '}
                        <a href="https://www.microsoft.com/en-us/windows/microsoft-edge">
                           Microsoft Edge
                        </a>, <a href="https://chrome.google.com/">Chrome</a> or{' '}
                     ...
                     <button
                        className="right"
                        onClick={() => {
                           document.getElementById('no-ie').style.display =
                              'none'
                        }}
                     >
                        Yeah whatevs
            ...
            <S.Greeting>
               ...
               >
                  My name is Tomomi, an aspiring web developer who loves
                  creating simple, elegant and eye-pleasing websites.<br />
                  <br />
                  In the recent past, I had been in a marketing research
                  industry querying away SQL and dealing with Microsoft Excel.
               </p>
               <p
                  className="p-2"
                  data-aos="fade"
                  ...
                  data-aos-anchor=".hello"
               >
                  The world has evolved whilst I was v-looking up cells, so I
                  decided to go back to school to learn new technologies, which
                  turned out to be one of the best decisions I've ever made.
                  <br />
                  <br />
                  In the more distant past, I grew up in Japan and that's what
                  makes me "me" now, although quite frequently it's mixed with
